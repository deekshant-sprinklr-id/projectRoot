...
public class CustomTransactionGuardImpl extends TransactionGuard {
    ...
    public CustomTransactionGuardImpl() {
    ...
    public void submitTransaction(@NotNull Disposable parentDisposable,
        ...
        ModalityState modality = expectedContext == null ? ModalityState.nonModal() : ((CustomTransactionGuardImpl.TransactionIdImpl)expectedContext).myModality;
    ...
    public void submitTransactionLater(final @NotNull Disposable parentDisposable, final @NotNull Runnable transaction) {
        CustomTransactionGuardImpl.TransactionIdImpl ctx = getContextTransaction();
    ...
    public TransactionIdImpl getContextTransaction() {
        ...
        ModalityState state = ModalityState.defaultModalityState();
        return isWriteSafeModality(state) ? new CustomTransactionGuardImpl.TransactionIdImpl(state) : null;
    }
    ...
    private static final class TransactionIdImpl implements TransactionId {
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof CustomTransactionGuardImpl.TransactionIdImpl)) return false;
            CustomTransactionGuardImpl.TransactionIdImpl id = (CustomTransactionGuardImpl.TransactionIdImpl)o;
