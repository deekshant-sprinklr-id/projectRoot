...
public class CustomFocusManagerImpl extends IdeFocusManager implements Disposable {
    ...
    public CustomFocusManagerImpl() {
        myQueue = IdeEventQueue.getInstance();

        ApplicationManager.getApplication().getMessageBus().connect().subscribe(ApplicationActivationListener.TOPIC, new CustomFocusManagerImpl.AppListener());
